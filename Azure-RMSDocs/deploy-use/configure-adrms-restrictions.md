...
보호하는 문서 및 이메일은 클라우드 또는 온-프레미스 환경에 저장할 수 있습니다 이 클라우드 기반 키에 대한 보호 프로세스 작동 방식에 대한 자세한 내용은 [Azure Rights Management란?](../understand-explore/what-is-azure-rms.md )를 참조하세요.
