# <a name="class-miprmsnullpointerexception"></a>클래스 mip::RMSNullPointerException 
RMS null 포인터 예외입니다.
## <a name="summary"></a>요약
 멤버                        | 설명                                
--------------------------------|---------------------------------------------
public inline  RMSNullPointerException public inline  RMSNullPointerException public inline virtual const char * what | 예외 메시지를 가져옵니다.
