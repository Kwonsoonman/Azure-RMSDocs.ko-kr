...
-   문서 공유를 중지해야 하는 경우 **허용 취소**를 클릭하고 문서를 계속 사용할 수 있는 기간을 확인한 다음, 이전에 공유했던 문서에 대한 액세스를 취소함을 사용자에게 알릴지와 사용자 지정된 메시지를 제공할지 여부를 결정합니다. 문서 액세스 권한을 해지하는 경우 공유한 문서가 삭제되지는 않지만 권한 있는 사용자가 이 문서를 더 이상 열 수 없게 됩니다.
...
-   Office 응용 프로그램(Word, Excel, PowerPoint, Outlook)의 경우 **홈** 탭, **보호** 그룹에서 **보호** > **사용 현황 추적**을 클릭합니다.
...
Office 응용 프로그램을 사용하여 Windows 컴퓨터에서 보호된 문서를 추적할 수 있을 뿐 아니라 다음과 같은 대체 방법을 사용할 수도 있습니다.
...
-   파일을 마우스 오른쪽 단추로 클릭하고 **분류 및 보호(미리 보기)**를 선택한 다음 **Azure Information Protection Viewer**에서 사용 현황 추적 아이콘을 선택합니다.
