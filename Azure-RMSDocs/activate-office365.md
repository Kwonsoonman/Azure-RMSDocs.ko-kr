...
3. **권한 관리** 페이지로 이동하거나 검색 기능을 사용합니다.
    ...
    서비스를 활성화하는 데 도움이 필요하거나 구독 요구 사항에 대한 질문이 있는 경우 [Microsoft 지원에 문의](information-support.md#to-contact-microsoft-support)하거나 표준 지원 채널을 사용하세요.
