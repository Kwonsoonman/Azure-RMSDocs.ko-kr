...
> [!NOTE]
> 보다 간편한 비교를 위해 이 표에 나와 있는 일부 정보는 [Azure Information Protection 요구 사항](../get-started/requirements-azure-rms.md)의 정보와 중복됩니다. Rights Management에 대한 더욱 구체적인 지원 및 버전 정보는 해당 원본을 사용하세요.
