...
테넌트 키를 다시 입력하려면 먼저 Key Vault에 Azure Information Protection 테넌트 키를 다시 입력합니다. 그런 다음 [Use-AadrmKeyVaultKey](/powershell/module/aadrm/use-aadrmkeyvaultkey) cmdlet을 다시 실행하여 새 키 URL을 지정합니다.
