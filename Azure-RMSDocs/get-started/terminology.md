...
|Rights Management 공유 응용 프로그램|현재 Azure Information Protection 클라이언트로 대체되며, Windows 및 가장 널리 사용되는 모바일 디바이스용의 선택적 응용 프로그램으로서 내부 및 메일을 통해 파일이 안전하게 공유되도록 합니다.|
