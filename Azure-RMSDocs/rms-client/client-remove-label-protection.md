...
Office 데스크톱 앱 **Word**, **Excel**, **PowerPoint**, **Outlook** 내에서 Office 문서 및 이메일을 만들거나 편집할 때 해당 문서 및 이메일에서 레이블 및 보호를 제거할 수 있습니다. 
...
>
> - 리본에 **보호** 단추가 표시되는 경우: **보호**를 선택한 다음, **표시줄 보기**를 선택합니다.
> 
...
4. 여러 파일에서 사용자 지정 보호를 제거하려면: **분류 및 보호 - Azure Information Protection** 대화 상자에서 **사용자 지정 권한 제거**를 클릭합니다.
