...
AD RMS에서 가져오는 템플릿은 Azure 포털에서 만들 수 있는 사용자 지정 템플릿과 모양 및 동작이 유사합니다. 가져온 템플릿을 사용자가 애플리케이션에서 보고 선택할 수 있도록 게시하기 위해 변경하려면 [Azure Information Protection용 템플릿 구성 및 관리](./configure-policy-templates.md)를 참조하세요.
