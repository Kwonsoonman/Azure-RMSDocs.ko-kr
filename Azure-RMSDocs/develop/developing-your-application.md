...
Azure Information Protection용으로 Azure AD 환경을 구성하려면 [Azure 권한 관리 활성화](https://docs.microsoft.com/information-protection/deploy-use/activate-service)의 지침을 따릅니다.

서비스가 활성화되면 다음 단계를 수행하기 위한 PowerShell 구성 요소를 준비해야 합니다. 이러한 구성 요소를 준비하려면 [Windows PowerShell을 사용하여 Azure Rights Management 서비스 관리](https://docs.microsoft.com/information-protection/deploy-use/administer-powershell)의 지침을 따릅니다.
