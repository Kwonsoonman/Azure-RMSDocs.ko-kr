...
## <a name="summary"></a>요약
 멤버                        | 설명                                
--------------------------------|---------------------------------------------
public bool AccessCheck | 정책이 지정된 액세스 권한을 사용자에게 부여하는지 확인합니다.
...
public std::shared_ptr< TemplateDescriptor > GetTemplateDescriptor public std::shared_ptr< PolicyDescriptor > GetPolicyDescriptor public std::string GetOwner | 콘텐츠 소유자의 메일 주소를 가져옵니다.
