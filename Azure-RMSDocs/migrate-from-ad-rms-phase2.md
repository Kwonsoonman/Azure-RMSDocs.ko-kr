...
ms.suite: ems
ms.openlocfilehash: 2d44397653bf4d8d3b8c7c99ee4257cf6af8f219
ms.sourcegitcommit: 5fdf013fe05b65517b56245e1807875d80be6e70
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 08/03/2018
ms.locfileid: "39490356"
---
...
AD RMS에서 가져오는 템플릿은 Azure 포털에서 만들 수 있는 사용자 지정 템플릿과 모양 및 동작이 유사합니다. 가져온 템플릿을 사용자가 응용 프로그램에서 보고 선택할 수 있도록 게시하기 위해 변경하려면 [Azure Information Protection용 템플릿 구성 및 관리](./configure-policy-templates.md)를 참조하세요.
...
이 구성에 대한 자세한 내용은 [Rights Management 보호를 적용하도록 레이블을 구성하는 방법](./configure-policy-protection.md)을 참조하세요.
