...
|Rights Management 웹 보고서|[Azure Information Protection의 중앙 집중식 보고](reports-aip.md)는 현재 미리 보기로 제공됩니다.<br /><br />[Get-AadrmUsageLog](/powershell/module/aadrm/Get-AadrmUsageLog) PowerShell cmdlet을 사용하여 Azure Rights Management 서비스에 대한 사용 현황 로그를 다운로드할 수도 있습니다. 그런 다음 이 데이터를 사용하여 사용자 지정 보고서를 만들 수 있습니다. 자세한 내용은 [Azure Rights Management Service의 사용 현황 로깅 및 분석](log-analyze-usage.md)을 참조하세요.
