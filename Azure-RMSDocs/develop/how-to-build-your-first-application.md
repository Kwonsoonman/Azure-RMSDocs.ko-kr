...
이렇게 하면 콘텐츠 키 hContentKey와 보호된 데이터에 연결해야 하는 직렬화된 라이선스 pSerializedLicense를 보유하게 됩니다.
...
이 단계를 마치면 암호화된 데이터 pbEncrypted와 소비자가 데이터 암호를 해독하는 데 사용할 직렬화된 라이선스 pSerializedLicense를 보유하게 됩니다.
