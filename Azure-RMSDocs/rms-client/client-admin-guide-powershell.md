...
> [!TIP]
> Set-AIPAuthentication이 성공하지 못하고 앞에서 설명한 지침에 따라 새 앱을 만들지 않고 기존 앱을 사용한 경우 앱에 필요한 권한을 다시 설정해야 할 수도 있습니다. Set-AIPAuthentication에 대한 새 앱을 만드는 지침을 수행한 다음 해당 앱의 설정을 수정한 경우에도 마찬가지입니다.
> 
> 이러한 두 가지 앱 모두에 대해 필요한 권한을 다시 설정하려면 이를 구성하는 단계를 사용합니다. 즉 **모든 설정** > **필요한 권한** > **권한 부여**를 차례로 선택한 다음 **예**를 클릭하여 확인합니다.
> 
> 또는 앞에서 설명한 지침에 따라 앱을 새로 만듭니다.
